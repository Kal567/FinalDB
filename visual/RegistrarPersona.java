   ...
   getContentPane().add(buttonPane, BorderLayout.SOUTH);
   {
    ...
    okButton.addActionListener(new ActionListener() {
     public void actionPerformed(ActionEvent e) {
       ...
       ControladorDB.getInstance().insertPersona(id_persona, p_nombre, s_nombre, p_apellido, s_apellido, ciudad, fecha, sexo);
       ...
       if (rdbtnUsuario.isSelected()) {
        ...
        ControladorDB.getInstance().insertUsuario(id_usuario, p_nombre, s_nombre, p_apellido, s_apellido, ciudad, fecha, sexo, 
          id_persona, contrasena, fechaDeUltimoAcceso, fechaDeRegistro, email);
       }
       if(rdbtnArtista.isSelected()) {
        ControladorDB.getInstance().insertArtista(id_artista, p_nombre, s_nombre, p_apellido, s_apellido, ciudad, fecha, sexo, id_artista, id_persona, nombreArtistico);
